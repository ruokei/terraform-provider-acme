...
resource "acme_certificate" "certificate" {
  ...
  #   provider = "alidns"
  #   config = {
  #     "ALICLOUD_ACCESS_KEY" = "LTAI5t7DdoJYr92XJvGgJgRT"
  #     "ALICLOUD_SECRET_KEY" = "cXb6VCyzTZ4IokaLnIwerlkRkzOVr8"
  #   }
  # }
  ...
  #   provider = "cloudflare"
  #   config = {
  #     "CLOUDFLARE_DNS_API_TOKEN"  = "HKc83foQi6nbZFQLBUgXk2Yyuk4oeK9Y26NMRJ2k"
  #     "CLOUDFLARE_ZONE_API_TOKEN" = "HKc83foQi6nbZFQLBUgXk2Yyuk4oeK9Y26NMRJ2k"
  #   }
  # }
}
